...
import ch.tbmelabs.authorizationserver.web.rest.GrantTypeController;
...
public class GrantTypeControllerTest {
  ...
  public void getAllGrantTypesShouldBeAnnotated() throws NoSuchMethodException, SecurityException {
    Method method = GrantTypeController.class.getDeclaredMethod("getAllGrantTypes", Pageable.class);
