...
import ch.tbmelabs.authorizationserver.web.rest.ClientController;
...
public class ClientControllerTest {
  ...
  public void createClientShouldBeAnnotated() throws NoSuchMethodException, SecurityException {
    Method method = ClientController.class.getDeclaredMethod("createClient", ClientDTO.class);
  ...
  public void getAllClientShouldBeAnnotated() throws NoSuchMethodException, SecurityException {
    Method method = ClientController.class.getDeclaredMethod("getAllClients", Pageable.class);
  ...
  public void updateClientShouldBeAnnotated() throws NoSuchMethodException, SecurityException {
    Method method = ClientController.class.getDeclaredMethod("updateClient", ClientDTO.class);
